(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('@angular/common/http'), require('rxjs/operators'), require('lodash'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('lms-ng-fhir', ['exports', '@angular/core', 'rxjs', '@angular/common/http', 'rxjs/operators', 'lodash', '@angular/common'], factory) :
    (global = global || self, factory(global['lms-ng-fhir'] = {}, global.ng.core, global.rxjs, global.ng.common.http, global.rxjs.operators, global.lodash, global.ng.common));
}(this, (function (exports, core, rxjs, http, operators, lodash, common) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     */
    /** @type {?} */
    var FHIR_CONFIG = new core.InjectionToken('FhirConfig');
    ...
    var FhirService = /** @class */ (function () {
        ...
        function (headers) {
            ...
            if (this.conformance)
                return rxjs.of(this.conformance);
            return this.httpClient.get(this.config.base + "/metadata", { headers: mergedHeaders }).pipe(operators.tap((/**
             * @param {?} result
             * @return {?}
             */
        ...
        function (resource, body, headers) {
            /** @type {?} */
            var headersToAttach = {};
            lodash.merge(headersToAttach, this.headers);
        ...
        FhirService.ctorParameters = function () { return [
            { type: FhirConfig, decorators: [{ type: core.Inject, args: [FHIR_CONFIG,] }] },
            { type: http.HttpClient }
        ]; };
        /** @nocollapse */ FhirService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function FhirService_Factory() { return new FhirService(core.ɵɵinject(FHIR_CONFIG), core.ɵɵinject(http.HttpClient)); }, token: FhirService, providedIn: "root" });
        return FhirService;
    }());
    if (false) {
        /** @type {?} */
    ...
    var FhirAdvancedService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ FhirAdvancedService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function FhirAdvancedService_Factory() { return new FhirAdvancedService(core.ɵɵinject(FHIR_CONFIG), core.ɵɵinject(http.HttpClient)); }, token: FhirAdvancedService, providedIn: "root" });
    ...
    exports.CommonSearchParameters = CommonSearchParameters;
    exports.ConceptDto = ConceptDto;
    exports.ConceptMap = ConceptMap;
    exports.ConceptMapDependsOn = ConceptMapDependsOn;
    ...
    exports.EqualSearchModifier = EqualSearchModifier;
    exports.Extension = Extension;
    exports.FhirAdvancedService = FhirAdvancedService;
    exports.FhirQueryBuilder = FhirQueryBuilder;
    ...
    exports.InstanceLevelInteractions = InstanceLevelInteractions;
    exports.Invoice = Invoice;
    exports.LeftPart = LeftPart;
    exports.Library = Library;
    exports.List = List;
    exports.LmsNgFhirModule = LmsNgFhirModule;
    ...
    exports.ResourceCapability = ResourceCapability;
    exports.ResourceTypes = ResourceTypes;
    exports.Schedule = Schedule;
    exports.SearchControlParameters = SearchControlParameters;
    exports.SearchItem = SearchItem;
    exports.SearchModifiers = SearchModifiers;
    exports.SearchSet = SearchSet;
    exports.Signature = Signature;
    exports.SimpleQuantity = SimpleQuantity;
    exports.Slot = Slot;
    exports.StringContainsSearchModifier = StringContainsSearchModifier;
    exports.StringExactSearchModifier = StringExactSearchModifier;
    exports.Substance = Substance;
    exports.Task = Task;
    exports.TerminologyCapabilities = TerminologyCapabilities;
    exports.Timing = Timing;
    exports.TypeLevelInteractions = TypeLevelInteractions;
    exports.UsageContext = UsageContext;
    exports.ValueSet = ValueSet;
    exports.VerificationResult = VerificationResult;
    exports.WholeSystemInteractions = WholeSystemInteractions;
    exports.ɵa = FhirAddressLineExtract;
    exports.ɵb = FhirContactExtractPipe;
    exports.ɵc = FhirDosageExctractPipe;
    exports.ɵd = FhirEmailExtractPipe;
    exports.ɵe = FhirNameExtractPipe;
    exports.ɵf = FhirTelecomPhoneExtract;
    exports.ɵg = FhirTelecomWebExtractPipe;
    exports.ɵh = FHIR_CONFIG;
    exports.ɵi = FhirConfig;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=lms-ng-fhir.umd.js.map
